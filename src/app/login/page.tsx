  ...
  return (
    <div className='md:flex md:flex-col lg:flex lg:flex-row h-screen'>
      <div className='lg:w-2/3 bg-red-400 h-10'>
        <img className='object-cover lg:h-screen w-full h-full' src="images/login.jpg" alt="" />
      </div>
        ...
        <div className='my-8 '>
          <form method='post' action='/dashboard' onSubmit={handleLogin}>
            ...
            <div className='flex w-full justify-center  '>
              <p className='text-sm'>Already have an account? <a href="" className='text-blue-500 font-bold'>Register</a> </p>
            </div>
          </form>
        </div>
        </div>
